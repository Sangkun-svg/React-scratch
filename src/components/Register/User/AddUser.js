...
export const AddUser = (props) => {
  ...
  const AddUserHandler = (e) => {
    e.preventDefault();
    const { username, age } = enteredUser;
    ...
    props.renderForNewUser({ id: Math.random(), ...enteredUser });
  ...
  const AddUserInputHadnler = ({ target: { name, value } }) => {
    setEnteredUser((preState) => {
